<h2><a href="https://leetcode.com/problems/good-subsequence-queries">3901. Good Subsequence Queries</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>nums</code> of length <code>n</code> and an integer <code>p</code>.</p>
